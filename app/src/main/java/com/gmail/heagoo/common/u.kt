...
final class u extends Thread {
    ...
    private InputStream f1472a

    /* renamed from: b, reason: collision with root package name */
    private Array<String> f1473b
    private Int c

    constructor(InputStream inputStream, Array<String> strArr, Int i) {
        this.f1472a = inputStream
        this.f1473b = strArr
        this.c = i
    }
    ...
    public final Unit run() throws IOException {
        ...
        try {
            InputStreamReader inputStreamReader = InputStreamReader(this.f1472a, "UTF-8")
            do {
        ...
        this.f1473b[this.c] = sb.toString()
    }
}
