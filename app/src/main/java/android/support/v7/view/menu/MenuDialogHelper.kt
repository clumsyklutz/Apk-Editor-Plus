...
class MenuDialogHelper implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, DialogInterface.OnKeyListener, MenuPresenter.Callback {
    ...
    constructor(MenuBuilder menuBuilder) {
    ...
    fun onKey(DialogInterface dialogInterface, Int i, KeyEvent keyEvent) {
        Window window
        View decorView
    ...
    fun setPresenterCallback(MenuPresenter.Callback callback) {
        this.mPresenterCallback = callback
    }

    fun show(IBinder iBinder) {
        MenuBuilder menuBuilder = this.mMenu
        AlertDialog.Builder builder = new AlertDialog.Builder(menuBuilder.getContext())
        this.mPresenter = ListMenuPresenter(builder.getContext(), R.layout.abc_list_menu_item_layout)
