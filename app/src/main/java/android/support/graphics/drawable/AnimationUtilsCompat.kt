    ...
    */
    private static android.view.animation.Interpolator createInterpolatorFromXml(android.content.Context r4, android.content.res.Resources r5, android.content.res.Resources.Theme r6, org.xmlpull.v1.XmlPullParser r7) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        Lc8:
            return r0
        */
        throw UnsupportedOperationException("Method not decompiled: android.support.graphics.drawable.AnimationUtilsCompat.createInterpolatorFromXml(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator")
    }

    fun loadInterpolator(Context context, Int i) {
        ...
        try {
            try {
                try {
                    if (i == 17563663) {
                        interpolatorCreateInterpolatorFromXml = FastOutLinearInInterpolator()
                    } else if (i == 17563661) {
                        interpolatorCreateInterpolatorFromXml = FastOutSlowInInterpolator()
                    } else if (i == 17563662) {
                        interpolatorCreateInterpolatorFromXml = LinearOutSlowInInterpolator()
                    } else {
